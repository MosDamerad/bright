...
$(function () {
    ...
    wind.on("scroll", function () {
        ...
        if (bodyScroll > 300) {
            ...
            logo.attr('src', '../../../www.innovationplans.com/idesign/avo2/img/logo-dark.html');

        } else {

            navbar.removeClass("nav-scroll");
            logo.attr('src', '../../../www.innovationplans.com/idesign/avo2/img/logo-light.html');
        }
    });
    ...
    $('.topnav .menu-icon').on('click', function () {
        ...
        if (open) {
            ...
            logoChan.attr('src', '../../../www.innovationplans.com/idesign/avo2/img/logo-light.html');
            ...
            logoChan.attr('src', '../../../www.innovationplans.com/idesign/avo2/img/logo-dark.html');
